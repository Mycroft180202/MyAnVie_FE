...
const teamMembers = [
  ...
  {
    id: 4,
    name: 'Hoàng Nguyên Nhật',
    position: 'CTO',
    image: '/images/AboutUs/Nhật.jpg',
  },
  {
    id: 5,
      ...
      <Box sx={{ position: 'relative', maxWidth: '1200px', mx: 'auto', px: 4 }}>
        <Slider ref={sliderRef} {...settings}>
          {teamMembers.map((member) => (
            <Box key={member.id} sx={{ textAlign: 'center', px: 0 }}>
              <Box sx={{ 
                bgcolor: '#fff',
                borderRadius: '12px',
                ...
                p: 2,
                mb: 2,
                mx: 2, // Added horizontal margin to increase spacing between member cards
              }}>
                <Box
                  component="img"
                  src={member.image}
